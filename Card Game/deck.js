...
createDeckBtn.addEventListener("click", () => {
  ...
  counterDisplay.innerText = `It Took You ${counter} Tries!`;
  counterDisplay.classList.add("counter_display");
  header.removeChild(createDeckBtn);
  header.append(counterDisplay);
  setTimeout(() => {
...
function htmlRender() {
  ...
  status_1.innerText = `Player 1: ${player_1_deck.length}`;
  status_2.innerText = `Player 2: ${player_2_deck.length}`;
}
